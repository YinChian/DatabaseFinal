                ...
                <div class="col-md-6 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-start h-100">
                        ...
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="px-2">
                                <h6 class="mb-0" style="font-weight: bold;">庫存</h6>
                                <p class="mb-0">1</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="px-2">
                                <h6 class="mb-0" style="font-weight: bold;">金額</h6>
                                <p class="mb-0">10</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-5 col-xl-4">
                    <div>
                        <form class="p-3 p-xl-4" method="post">
                            <div class="mb-3"><input class="form-control" type="text" id="name-1" name="name" placeholder="數量 / Quantity" inputmode="numeric" autocomplete="off" autofocus="" required="" pattern="^-?[1-9]\d*$" minlength="1" maxlength="10"></div>
                            <div class="mb-3"></div>
                            <div><button class="btn btn-primary d-block w-100" type="submit">前往付款 / Checkout</button></div>
                        </form>
                    </div>
                </div>
            </div>
