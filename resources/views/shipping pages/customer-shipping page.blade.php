        ...
        <div class="row gy-4 gy-md-0">
            ...
            <div class="col-md-6 d-md-flex align-items-md-center">
                <div style="max-width: 350px;">
                    <h2 class="text-uppercase fw-bold">物流查詢功能</h2>
                    <p class="my-3">您可以在這邊查詢物流資訊！</p><a class="btn btn-primary btn-lg me-2" role="button" href="#">檢視</a><a class="btn btn-outline-primary btn-lg" role="button" href="#">前往購物</a>
                </div>
            </div>
        </div>
    </div>
