        ...
        <div class="container h-100">
            <div class="row h-100">
                <div class="col-md-10 col-xl-8 text-center d-flex d-sm-flex d-md-flex justify-content-center align-items-center mx-auto justify-content-md-start align-items-md-center justify-content-xl-center">
                    <div>
                        <h2 class="text-uppercase fw-bold mb-3">個人資料管理</h2>
                        <p class="mb-4">您可以在這邊更新您的個人資料，或是完整的刪除您的資料。</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                        <div class="card mb-5">
                            <div class="card-body p-sm-5">
                                <form method="post">
                                    <div class="mb-3"><label class="form-label">使用者名稱</label><input class="form-control" type="text" id="name-2" name="name" placeholder="Name" value="{%default%}"></div>
                                    <div class="mb-3"><label class="form-label">電話號碼</label><input class="form-control" type="text" id="name-1" name="name" placeholder="Name" value="{%default%}"></div>
                                    <div class="mb-3"><label class="form-label">住址</label><input class="form-control" type="text" id="name-3" name="name" placeholder="Name" value="{%default%}"></div>
                                    <div class="mb-3"><label class="form-label">電子郵件</label><input class="form-control" type="email" id="email-2" name="email" placeholder="Email" value="{%default%}"></div>
                                    <div style="padding-bottom: 16px;"><button class="btn btn-primary d-block w-100" type="submit">確定</button></div>
                                    <div><button class="btn btn-primary d-block w-100" type="submit" style="background: var(--bs-danger);border-color: var(--bs-danger);">刪除帳號</button></div>
                                </form>
                            </div>
                        </div>
                    </div>
