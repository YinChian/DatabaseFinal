        ...
        <div class="row gy-4 gy-md-0">
            ...
            <div class="col-md-6 d-md-flex align-items-md-center">
                <div style="max-width: 350px;">
                    <h2 class="text-uppercase fw-bold">客戶服務中心</h2>
                    <p class="my-3">歡迎來到客戶服務中心。如果對商品，或是本系統提供的服務有疑問的話，可在此與我們反映！</p><a class="btn btn-primary btn-lg me-2" role="button" href="#">提起客服</a><a class="btn btn-outline-primary btn-lg" role="button" href="#">客服紀錄</a>
                </div>
            </div>
        </div>
    </div>
