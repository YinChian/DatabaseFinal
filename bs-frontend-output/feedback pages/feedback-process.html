...
<body>
    ...
    <div class="container py-4 py-xl-5">
        <div class="row gy-4 gy-md-0">
            <div class="col-md-6">
                <div class="p-xl-5 m-xl-5"><img class="rounded img-fluid w-100 fit-cover" style="min-height: 300px;" src="../assets/img/83465180_2307-w019-n001-1A-p18-1.jpg"></div>
            </div>
            <div class="col-md-6 d-md-flex align-items-md-center">
                <div style="max-width: 350px;">
                    <h2 class="text-uppercase fw-bold">客戶服務處理中心</h2>
                    <p class="my-3">面對客戶時，請記得保持友善、包容與尊重。祝您有個美好的一天！</p><a class="btn btn-primary btn-lg me-2" role="button" href="#">開始使用</a><a class="btn btn-outline-primary btn-lg" role="button" href="#">回首頁</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row row-cols-2 row-cols-md-4">
                <div class="col">
                    <div class="p-3">
                        ...
                        <p class="mb-0">未處理件總計</p>
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">
                        <h4 class="display-5 fw-bold text-white mb-0">0</h4>
                        <p class="mb-0">產品相關之客服件</p>
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">
                        <h4 class="display-5 fw-bold text-white mb-0">0</h4>
                        <p class="mb-0">非產品相關之客服件</p>
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">
                        <h4 class="display-5 fw-bold text-white mb-0">0</h4>
                        <p class="mb-0">已處理件總計</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Cell 4</td>
                                <td>Cell 5</td>
                                <td><button class="btn btn-primary" type="button">解決</button></td>
                            </tr>
                            <tr>
                                <td>Cell 1</td>
                                <td>Cell 2</td>
