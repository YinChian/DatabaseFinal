...
<body>
    ...
    <div class="container py-4 py-xl-5">
        <div class="row gy-4 gy-md-0">
            <div class="col-md-6">
                <div class="p-xl-5 m-xl-5"><img class="rounded img-fluid w-100 fit-cover" style="min-height: 300px;" src="../assets/img/6251129.jpg"></div>
            </div>
            <div class="col-md-6 d-md-flex align-items-md-center">
                <div style="max-width: 350px;">
                    <h2 class="text-uppercase fw-bold">庫存管理系統</h2>
                    <p class="my-3">歡迎使用庫存管理系統。</p><a class="btn btn-primary btn-lg me-2" role="button" href="#">新增庫存</a><a class="btn btn-outline-primary btn-lg" role="button" href="#">修改庫存</a>
                </div>
            </div>
        </div>
    </div>
