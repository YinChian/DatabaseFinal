...
<body>
    ...
    <div class="container py-4 py-xl-5">
        <div class="row gy-4 gy-md-0">
            <div class="col-md-6">
                <div class="p-xl-5 m-xl-5"><img class="rounded img-fluid w-100 fit-cover" style="min-height: 300px;" src="../assets/img/6143178_3142958.jpg"></div>
            </div>
            <div class="col-md-6 d-md-flex align-items-md-center">
                <div style="max-width: 350px;">
                    <h2 class="text-uppercase fw-bold">物流士管理功能</h2>
                    <p class="my-3">您可以在這邊控管物流</p><a class="btn btn-primary btn-lg me-2" role="button" href="#">前往管理</a><a class="btn btn-outline-primary btn-lg" role="button" href="#">登出</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Cell 4</td>
                                <td>Cell 5</td>
                                <td><button class="btn btn-primary" type="button">標註為送達</button></td>
                            </tr>
                            <tr>
                                <td>Cell 1</td>
                                <td>Cell 2</td>
